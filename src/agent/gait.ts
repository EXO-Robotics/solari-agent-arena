import type { ActuatorTargets, SensorFrame } from "../sim/types";

export function agentGaitTargets(robot: SensorFrame): Partial<ActuatorTargets> {
  ...
  return {
    ...
    left_ankle_pitch: -0.1 + stride * 0.45 - pitchFix * 0.8,
    right_ankle_pitch: -0.1 - stride * 0.45 - pitchFix * 0.8,
